...
class CreateAlltimeGoalieStatsTable extends Migration
{
    public function up(): void
    {
        Schema::create('alltime_goalie_stats', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('alltime_goalie_stats');
    }
}
