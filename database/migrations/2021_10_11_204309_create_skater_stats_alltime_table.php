...
class CreateSkaterStatsAlltimeTable extends Migration
{
    public function up(): void
    {
        Schema::create('skater_stats_alltime', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('skater_stats_alltime');
    }
}
